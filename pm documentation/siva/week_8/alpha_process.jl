...
# ╔═╡ 4ba805e6-b2d7-47e5-8d99-1740fd94b78a
using Catlab, Catlab.CategoricalAlgebra, Catlab.Programs, Catlab.WiringDiagrams, Catlab.Graphics

# ╔═╡ 5e6e39bf-745e-48a7-831c-d1d91470f8db
using AlgebraicPetri

# ╔═╡ b440dfa6-61f1-4520-a63a-128edd2adc5c
using AlgebraicDynamics.UWDDynam

# ╔═╡ 011ae942-dff2-4db9-9989-2d2e123dd15c
using DifferentialEquations

# ╔═╡ 6b7fadbb-8861-4b2b-857c-ecd1936e4319
using LabelledArrays

# ╔═╡ 43d79578-2f54-4fc8-99c3-df83e56f7b2f
using Plots

# ╔═╡ 8775ac90-750f-11ef-1049-3f9fb0d7143a
md"""
Libraries used are:
...
# ╔═╡ 949e7636-f4f0-4ff9-9640-179d93857952
md"""
...
# ╔═╡ 1bb2968f-75b5-4196-bf08-eacc5136fdc5
...
# ╔═╡ 49ecd498-b15a-476e-87f6-a6ad02109ee6
...
# ╔═╡ 2454a980-dd49-4afe-b892-679bc22b136a
md"""
Creating open petri-nets for each reaction in the **"alpha process"**.
"""

# ╔═╡ a198dfc9-de0e-48ff-aa49-ee409ca68d0f
begin
...
# ╔═╡ 653c250e-c253-4320-bac7-503a9350f3f8
md"""
Thanks to Hirithik, he gave the below code snippet which helps to visualise the composition more clearly.
"""

# ╔═╡ 9e32c78d-7cdb-43b9-ba14-0a21eaa026d9
...
# ╔═╡ 873b6814-5be8-4373-9383-80ee2f048399
md"""
...
# ╔═╡ db97bbf3-fbe6-44fd-b192-259d2c76b1de
begin
...
# ╔═╡ 9c224db4-30e6-4b61-bf6d-75b14685aff9
md"""
`oapply` is used to apply the composition pattern on the open petri-nets.
"""

# ╔═╡ e5f037e3-f994-4556-846d-89b30d0f4b55
begin
	...
	to_graphviz(rxn_composite, program="osage")
end

# ╔═╡ c5738fca-54f9-46c4-bfc2-f5a0c53ec4b8
md"""
...
# ╔═╡ 708195b5-eaab-48dc-aaed-6a26f07e1e84
md"""
...
# ╔═╡ a47f7909-ca18-4468-ab4b-14f483433749
begin
...
# ╔═╡ 26ea28b4-5c6b-4598-8eb1-b1485548c84f
md"""
You can also view the solution curve for each element using the command:

`plot(soln.t, soln[20, :], label="Cr_stable", linewidth=3)` (Cr_stable is the 20th component of soln vector)
"""

# ╔═╡ 26b213f2-3197-4e61-8f7e-eddd0cb11261
plot(soln.t, soln[20, :], label="Cr_stable", linewidth=3)

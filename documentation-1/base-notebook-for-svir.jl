...
# ╔═╡ 7371b1f0-6b8a-11ef-26c0-ebaeafab10f8
begin
	# import modules
...
# ╔═╡ f65a98fc-a002-4d6c-ac12-2b0341613755
...
# ╔═╡ c0654e12-6beb-4868-99ae-3e49716f9437
to_graphviz(SIR)

# ╔═╡ e9717c4a-0e29-43e5-9063-6395b1d3840c
to_graphviz(VIvR)

# ╔═╡ 5f394e43-37e0-4721-b001-996e9838e250
to_graphviz(cross_exposure)

# ╔═╡ bf2b13ff-47c6-4f32-a818-d236ff878dbf
to_graphviz(SVIIvR)

# ╔═╡ da2ddb54-116b-4365-88e3-48e27a44d39f
begin
	params = LVector(inf_uu = 2, rec_u = 2,
					 inf_vv = 2, rec_v = 2, 
					 inf_uv = 3, inf_vu = 1,
					 vax = 2)
	u0 = LVector(S = 100, I = 0, R = 0, V = 50, Iv = 20)
	tspan = (0., 3.)
end;

# ╔═╡ c6686915-fdcb-48e9-91e5-90a46f8ba225
prob = ODEProblem(SVIIvR, u0, tspan, params);

# ╔═╡ 23b35b28-6678-4ee2-8dfb-7d883f316816
sol = solve(prob, Tsit5());

# ╔═╡ 1d9be7be-c7b2-438c-80e1-adba7005dca7
plot(sol,
  lw = 2,
  label = ["S" "I" "R" "V" "Iv"],
...
# ╔═╡ c509ebbd-9e08-49d8-b55c-86234065099e


# ╔═╡ 3fbab26c-623c-4ba6-a6f2-2191eab701e1


# ╔═╡ e2e70806-0064-4741-990b-5f41b47f7d4a


# ╔═╡ 92acaa7e-3f5a-4124-8365-eab598e440a8


# ╔═╡ aff8f0cd-ec9b-4119-b05e-1e77dbd23c18


# ╔═╡ e947f5b5-e7a7-4b77-8b5f-bc366aa91733


# ╔═╡ 7a1db796-b0b6-41db-a998-68369ff211ea


# ╔═╡ f5375a15-87d7-49b2-a82b-0592118eddc6


# ╔═╡ beeda64d-3429-49d6-9688-a25758f31250


# ╔═╡ be126de4-a10e-4fa7-b53c-e427c4f3063e


# ╔═╡ 172f7692-c509-4b4b-8364-f77c4552e9d8


# ╔═╡ acc7fb8b-a4c6-451e-ad7c-727dfe0e15f4


# ╔═╡ 68d2df1a-dbfa-48a2-b565-bd9c15be77c6


# ╔═╡ 4b2d03e1-a9b1-4ceb-8b23-5db3e3ad355e


# ╔═╡ 04b9fe5b-cca8-4dcc-8d29-eac5d4ca1f23


# ╔═╡ 9e238b04-6f14-4491-9bdb-25717f29cedd
...
manifest_format = "2.0"
project_hash = "a377e4b9473e8eb062dc65eff4c937ddd5a79c47"
...
git-tree-sha1 = "c30dc831e0a613f3a3433b5d976df868b6c2335e"
